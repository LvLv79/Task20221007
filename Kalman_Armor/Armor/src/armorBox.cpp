 ...
 */
const Point2f calCenter(const Point2f& bl,const Point2f& tl,const Point2f& tr, const Point2f& br){
	float a1 = tr.y - bl.y;
	float b1 = tr.x - bl.x;
...
ArmorBox::ArmorBox(const LightBar & l_light, const LightBar & r_light) {
	...
	//calculate armor center
	center = calCenter(armorVertices[0], armorVertices[1], armorVertices[2], armorVertices[3]);
